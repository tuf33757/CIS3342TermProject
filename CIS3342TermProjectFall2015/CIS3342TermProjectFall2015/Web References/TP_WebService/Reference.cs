...
namespace CIS3342TermProjectFall2015.TP_WebService {
    ...
    public partial class TP_WebService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public bool Purchase(string ProductID, int Quantity, string SiteID, string APIKey, string[] CustomerCreditInformation) {
        ...
        /// <remarks/>
        public void PurchaseAsync(string ProductID, int Quantity, string SiteID, string APIKey, string[] CustomerCreditInformation) {
            this.PurchaseAsync(ProductID, Quantity, SiteID, APIKey, CustomerCreditInformation, null);
        }
        
        /// <remarks/>
        public void PurchaseAsync(string ProductID, int Quantity, string SiteID, string APIKey, string[] CustomerCreditInformation, object userState) {
