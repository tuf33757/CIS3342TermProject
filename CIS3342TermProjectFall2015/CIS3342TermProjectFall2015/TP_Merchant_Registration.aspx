    ...
    <div class="container">
        <div id="registerMerch" class="register" runat="server">
            <form id="Form3" class="form-register-merch" runat="server">
                ...
                <asp:TextBox ID="txtStoreName" runat="server" BackColor="#0F3D0F" BorderColor="Black"></asp:TextBox>
                <br />
                <br />
                <asp:Label ID="lblStoreDescrip" runat="server" Text="Store Description: "></asp:Label>
                <br />
                <asp:TextBox ID="txtStoreDescription" runat="server" Height="100px" Width="349px" BackColor="#0F3D0F" BorderColor="Black"></asp:TextBox>
                <br />
                <br />
                <asp:Label ID="lblOwnerFirstName" runat="server" Text="Owner First Name: "></asp:Label>
                <asp:TextBox ID="txtFirstName" runat="server" BackColor="#0F3D0F" BorderColor="Black"></asp:TextBox>
                <br />
                <br />
                <asp:Label ID="lblOwnerLastName" runat="server" Text="Owner Last Name: "></asp:Label>
                <asp:TextBox ID="txtLastName" runat="server" BackColor="#0F3D0F" BorderColor="Black"></asp:TextBox>
                <br />
                <br />
